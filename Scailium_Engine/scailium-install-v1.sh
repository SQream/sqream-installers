...
########################## limitQuery no meta ###############################################################################################
limitQuery_no_meta_mig () {
logit "Started:  limitQuery_no_meta_mig"
copy_files
total_ram
number_of_workers=$(ls -dq /etc/sqream/*sqream*-service.conf | wc -l)
limitQueryMemoryGB=$((AVAILABLE_RAM_GB / number_of_workers))
...
logit "Success:  limitQuery_no_meta_mig"        
install_legacy_mig
} 
...
logit "Started:  limitQuery_no_meta_aws"
total_ram
number_of_workers=$(ls -dq /etc/sqream/*sqream*-service.conf | wc -l)
limitQueryMemoryGB=$((AVAILABLE_RAM_GB / number_of_workers))
if  [ $limitQueryMemoryGB -ge 128 ] ; then
...
logit "Success:  limitQuery_no_meta_aws"
install_legacy_aws
}
#################################################################################################################################################
################# check_monit_service_health #########################################################################################################
...
logit "Success:  limitQuery_no_meta"        
install_legacy
} 
...
help () 
{
  ...
  echo "---------------------------------------------------------------------------------------------------"
  echo "-f,                     Install Scailium On-Prem with Monit"
  echo "                        example: sudo ./scailium-install-v1.sh -f < path to SQreamDB Package> "
  echo "---------------------------------------------------------------------------------------------------"  
  echo "-a,                     Reconfig Scailium On-Prem with Monit"
  echo "                        example: sudo ./scailium-install-v1.sh -a "
  echo "---------------------------------------------------------------------------------------------------"
  echo "-u,                     Upgrade Scailium Version"
  echo "                        example: sudo ./scailium-install-v1.sh -u < path to SQreamDB Package> "
  echo "---------------------------------------------------------------------------------------------------"
  echo "-aws,                   Install Scailium On AWS Cloud"
  echo "                        example: sudo ./scailium-install-v1.sh -aws < path to SQreamDB Package>  "
  echo "---------------------------------------------------------------------------------------------------"
  echo "-reaws,                 Reconfig Scailium On AWS Cloud"
  echo "                        example: sudo ./scailium-install-v1.sh -reaws "
  echo "---------------------------------------------------------------------------------------------------"
  echo "-oci,                   Install Scailium On OCI Cloud "
  echo "                        example: sudo ./scailium-install-v1.sh -oci < path to SQreamDB Package> "
  echo "---------------------------------------------------------------------------------------------------"
  echo "-reoci,                 Reconfig Scailium On OCI Cloud "
  echo "                        example: sudo ./scailium-install-v1.sh -oci "  
  echo "---------------------------------------------------------------------------------------------------"
  echo "-metadata,              Install Scailium METADATA only"
  echo "                        example: sudo ./scailium-install-v1.sh -metadata < path to SQreamDB Package> "
  echo "---------------------------------------------------------------------------------------------------"
  ...
  echo "---------------------------------------------------------------------------------------------------"
  echo "-mig,                   Install Scailium MIG support"
  echo "                        example: sudo ./scailium-install-v1.sh -mig "
  echo "---------------------------------------------------------------------------------------------------"  
  echo "-remig,                 reconfigure Scailium MIG support"
  echo "                        example: sudo ./sqream-install-v1.sh -remig "
  echo "---------------------------------------------------------------------------------------------------"
  echo "-E,                     Expert Reconfiguration for Scailium on monit"
  echo "                        example: sudo ./scailium-install-v1.sh -E "
  echo "---------------------------------------------------------------------------------------------------"
  echo "-L,                     View Log File ( logfile path: /tmp/sqream-installV1.log )"
  echo "                        example: sudo ./scailium-install-v1.sh -L "
  echo "---------------------------------------------------------------------------------------------------"
  echo "-S,                     View Summary Log File"
  echo "                        example: sudo ./scailium-install-v1.sh -S "
  echo "###################################################################################################"
  exit
}
if [[ $# = 0 ]];then
